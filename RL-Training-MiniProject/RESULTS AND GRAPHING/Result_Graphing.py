...
problem2_folder = os.path.join(script_dir, "Problem 2", "With Gait and Obs")
problem2_noObs_folder = os.path.join(script_dir, "Problem 2", "With Gait No Obs")
...
le_events = event_acc.Scalars(lin_err_tag)
le_steps1 = [e.step for e in le_events]
le_values1 = [e.value for e in le_events]
